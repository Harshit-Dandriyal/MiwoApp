...
class CustomAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout TextBoxes=(LinearLayout) listItemView.findViewById(R.id.linear_text_box);

        TextBoxes.setBackgroundResource(ColorResourceId);
        ...
        {
            MiwoImage.setVisibility(View.GONE);
        }
